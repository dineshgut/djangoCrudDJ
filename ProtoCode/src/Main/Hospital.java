...
/**
 *
 * @author Deenadayal -- Robotics Engineer
 */
public class Hospital extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Welcome To HMSMS");
        setResizable(false);
        setSize(new java.awt.Dimension(800, 480));

       /* JLabel background1 = new JLabel(new ImageIcon("/Images/resizeHMSMS.jpg"));
        //background1=new JLabel(",")
        background1.setBounds(0, 0, 800, 480);
        add(background1);*/
        ...
        adminButton.setIcon(new ImageIcon(Hospital.class.getResource("/Icon/admin.png")));
        ...
        //ImageIcon imgbg=new ImageIcon();
             
        //mLabel.getBackground("back",background1);
        //mLabel.setBackground(new javax.swing.ImageIcon(getClass().getResource("")));
        ...
        mLabel.setText("Hospital Medical Software Management System");
        ...
        MainFLayout.setHorizontalGroup(
        	MainFLayout.createParallelGroup(Alignment.LEADING)
        		.addComponent(mLabel, GroupLayout.DEFAULT_SIZE, 1101, Short.MAX_VALUE)
        		.addGroup(MainFLayout.createSequentialGroup()
        			.addGroup(MainFLayout.createParallelGroup(Alignment.TRAILING, false)
        ...
        MainFLayout.setVerticalGroup(
        	MainFLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(MainFLayout.createSequentialGroup()
        			.addComponent(mLabel, GroupLayout.PREFERRED_SIZE, 59, GroupLayout.PREFERRED_SIZE)
        			.addGap(10)
        			.addComponent(jPanel4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addGap(85)
        			.addGroup(MainFLayout.createParallelGroup(Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(Alignment.TRAILING, layout.createSequentialGroup()
        			.addGap(61)
        			.addComponent(MainF, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        			.addContainerGap())
        );
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addComponent(MainF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap())
        );
