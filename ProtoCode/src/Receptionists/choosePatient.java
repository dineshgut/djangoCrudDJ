...
public class choosePatient extends javax.swing.JFrame {
    ...
    public choosePatient() {
        ...
        Object columns[] = {"Date", "Id", "Name", "Age", "BloodGroup", "Gender", "Address", "Phone Number", "Status", "Disease", "Room Number"};
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select date,id,name,age,bGroup,gender,address,phone,status,disease,room from patient where name LIKE '" +"%"+ searchKey + "%" + "'";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[4] = rs.getString("bGroup");
